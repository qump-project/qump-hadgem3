...
[Link to notebook](https://nbviewer.jupyter.org/github/qump-project/qump-hadgem3/blob/master/notebooks/read_csvfile_pandas.ipynb) on how to read CSV files that store the parameter perturbations for the following base model configurations:
   * **GA7**
      ...
      * [20 parameter combinations used for Yamazaki et al (2020)](https://github.com/qump-project/qump-hadgem3/blob/master/data/ukcp18_strand2_ppe20.csv) <a href="https://github.com/qump-project/qump-hadgem3/blob/master/data/ukcp18_strand2_ppe20.csv" download="ukcp18_strand2_ppe20.csv">Download</a>
