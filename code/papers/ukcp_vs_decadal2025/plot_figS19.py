...
namearr = ['Northern Europe_djf_tas', 'Northern Europe_jja_tas','Northern Europe_djf_pr', 'Northern Europe_jja_pr'] 
fparr   = [1, 1, 1, 1]
...
for iname,longname,fp,ylabel,nmx in zip(range(len(namearr)),namearr, fparr,ylabels,nmaxa):
    ...
    if iname == 0:
        ...
        tit='NEU winter precipitation, T1'
        ylim=[-15.5, 21.5]
        xlim=[1960., 2018.5]

    elif iname == 3:
        tit='NEU summer precipitation, T1'
        ylim=[-20.0, 20.0]
        xlim=[1960., 2018.5]
    ...
    plt.ylabel(ylabel)
    loc='upper left'            
    leg1 = plt.legend(ll, labels, loc=loc, fontsize=fs-0.5, handlelength=1.0,borderaxespad=0.05,handletextpad=0.25,labelspacing=0.20,frameon=False)
