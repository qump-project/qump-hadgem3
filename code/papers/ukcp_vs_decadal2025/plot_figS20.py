...
for iname,longname,fp,ylabel,nmx in zip(range(len(namearr)),namearr, fparr,ylabels,nmaxa):
    ...
    if iname == 0:
        tit='EngWal winter Tair, T2-9'
        ylim=[-1.15, 1.30]
        xlim=[1965.0, 2020]

    elif iname == 1:
        tit='EngWal summer Tair, T2-9'
        ylim=[-0.75, 1.85]
        xlim=[1965.0, 2020.5]

    elif iname == 2:
        tit='EngWal winter precipitation, T2-9'
        ylim=[-8.0, 12.0]
        xlim=[1965.0, 2020]

    elif iname == 3:
        tit='EngWal summer precipitation, T2-9'
        ylim=[-13.5, 14.3]
        xlim=[1965.0, 2020.5]
    ...
    if iname == 0:
        ...
        leg2 = plt.legend(ll2, labels2, loc='lower right', fontsize=fs-1.0, frameon=False, ncol=2, columnspacing=0.6,
